...
class FScore(Measure):
    ...
    def measure(self, recs, n=None):
        ...
        >>> p = FScore()
        >>> p.measure([(False, 0.9), (True, 0.8), (False, 0.7), (False, 0.6), (True, 0.5), (True, 0.4), (True, 0.3), \
        ...
        n = n or float(len([gt for gt, _ in recs if gt]))  # Compute number of relevant items in the list
        ...
        relevant_items = float(len([gt for gt, _ in recs if gt]))

        precision = relevant_items / len(recs)
        recall = relevant_items / n
...
class Precision(Measure):
    ...
    def measure(self, recs, n=None):
        ...
        0.0
        >>> p.measure([(True, 0.3), (True, 0.25), (True, 0.25), (True, 0.2), (False, 0.19),(False, 0.19),\
         (True, 0.18), (False, 0.17),(False, 0.17), (False, 0.17)  ])
        0.5
        >>> p.measure([(False, 0.9), (True, 0.8), (False, 0.7), (False, 0.6), (True, 0.5), (True, 0.4), (True, 0.3), \
        (False, 0.2), (False, 0.1), (False, 0)])
        0.4
...
class Recall(Measure):
    ...
    def measure(self, recs, n=None):
        ...
        >>> 
        >>> p.measure([(True, 0.3), (True, 0.25), (True, 0.25), (True, 0.2), (False, 0.19),(False, 0.19), \
        (True, 0.18), (False, 0.17),(False, 0.17), (False, 0.17)  ], n = 10)
        0.5
        >>> p.measure([(False, 0.9), (True, 0.8), (False, 0.7), (False, 0.6), (True, 0.5), (True, 0.4), (True, 0.3), \
        (False, 0.2), (False, 0.1), (False, 0)], n = 10)
        0.4
        """
        if not recs or not isinstance(recs, list) or len(recs) < 1:
                return float("nan")

        n = n or float(len([gt for gt, _ in recs if gt]))
